...
def agregar_tarea():
    tarea = input("Ingrese el nombre de la tarea que desea agregar: ")
    tareas.append(tarea)
...
def mostrar_menu():
    while True:
        ...
        if eleccion == '0':
            ...
            agregar_tarea()  # Llamamos a la función para agregar tarea
        elif eleccion == '2':
            mostrar_tareas()  # Llamamos a la función para mostrar las tareas
        else:
            print("Opción no válida. Por favor, intenta de nuevo.")
